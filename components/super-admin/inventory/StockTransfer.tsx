...
// Complete mock data for Super Admin transfer history
const MOCK_GLOBAL_TRANSFERS = [
  ...
  { id: "GTN-103", item: "Headphones", qty: 5, from: "Main Branch", to: "Kandy Branch", status: "completed", date: "2026-04-16" },
  ...
  { id: "GTN-100", item: "Bread", qty: 25, from: "Kandy Branch", to: "Galle Branch", status: "completed", date: "2026-04-13" },
];

export default function StockTransfer() {
  const [isProcessing, setIsProcessing] = useState(false);
  const [transfers] = useState(MOCK_GLOBAL_TRANSFERS);
          ...
          <form onSubmit={handleTransfer} className="space-y-4 sm:space-y-5">
            <div className="space-y-2">
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectItem value="coke">Coca Cola (Main:45, Kandy:80, Galle:60)</SelectItem>
                  <SelectItem value="bread">Bread (Main:30, Kandy:40, Galle:30)</SelectItem>
                  <SelectItem value="tshirt">T-Shirt (Main:5, Kandy:5, Galle:25)</SelectItem>
                  <SelectItem value="water">Mineral Water (Main:0, Kandy:0, Galle:50)</SelectItem>
                  <SelectItem value="rice">Rice 5kg (Main:8, Kandy:8, Galle:25)</SelectItem>
                  <SelectItem value="headphones">Headphones (Main:15, Kandy:0, Galle:15)</SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            >
              {isProcessing ? "Processing..." : "Initiate Global Transfer"}
            </Button>
          </form>
        </CardContent>
      </Card>
      ...
      <Card className="border-border shadow-lg lg:col-span-2">
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-base sm:text-lg text-foreground">
            ...
            Recent GTN (Transfer Notes) - Global
          </CardTitle>
        </CardHeader>
        <CardContent>
