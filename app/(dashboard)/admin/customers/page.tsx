    ...
    <div className="space-y-4 sm:space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <Button
          ...
          className="bg-primary hover:bg-primary-hover font-black uppercase text-[10px] sm:text-xs h-10 sm:h-12 px-4 sm:px-8 shadow-xl"
        >
        ...
        <div className="lg:col-span-2 h-full">
          <CustomerDetails
            ...
            onCreditSettled={(id: any, amt: any) => {
              const updated = {
                ...selectedCustomer,
                credit: Math.max(0, selectedCustomer.credit - amt),
              };
